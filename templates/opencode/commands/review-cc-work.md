...
You are **OpenCode (PM)**. Receive the completion report from Claude Code (output of /handoff-to-opencode) and review the changes.
...
After completing the commit, report via `/handoff-to-opencode`
~~~
...
After completion, report via `/handoff-to-opencode`
~~~
