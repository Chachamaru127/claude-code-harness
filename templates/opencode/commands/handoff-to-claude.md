...
You are **OpenCode (PM)**. Generate a work request to pass to Claude Code in a copy-and-paste-ready format.
...
**After completing work**: run `/handoff-to-opencode` to report completion
```
