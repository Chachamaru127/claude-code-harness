...
# Temporary file for JSON output (with automatic cleanup)
RESULT_FILE=$(mktemp)
...
detect_tech_stack() {
  ...
  if [ -f "package.json" ]; then
    ...
    # Framework detection (pattern match against cached content)
...
# ================================
# 4. Existing Claude/Cursor configuration detection
# ================================
